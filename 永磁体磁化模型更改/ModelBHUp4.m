...
% ModelBHUp4.m
%
% Model exported on Oct 20 2021, 22:13 by COMSOL 5.6.0.280.
...
model.component('comp1').view('view1').axis.set('ymin', 47.197113037109375);
model.component('comp1').view('view1').axis.set('ymax', 48.639984130859375);
