...
% ModelBHUpLine.m
%
% Model exported on Oct 21 2021, 17:02 by COMSOL 5.6.0.280.
...
model.component('comp1').geom('geom1').feature('ls1').set('coord2', [10.1 43]);
...
model.component('comp1').geom('geom1').feature('ls2').set('coord2', [10.1 48]);
...
model.component('comp1').mesh('mesh1').feature('fq1').selection.set([3 5]);
model.component('comp1').mesh('mesh1').feature('fq1').create('size1', 'Size');
model.component('comp1').mesh('mesh1').feature('fq1').feature('size1').selection.set([3 4 5]);
...
model.component('comp1').view('view1').axis.set('xmin', 1.470799207687378);
model.component('comp1').view('view1').axis.set('xmax', 61.29096221923828);
model.component('comp1').view('view1').axis.set('ymin', 32.34580993652344);
model.component('comp1').view('view1').axis.set('ymax', 62.70041275024414);
