...
% ModelBHUplook.m
%
% Model exported on Oct 21 2021, 17:09 by COMSOL 5.6.0.280.
...
model.modelPath(['D:\GitHub\paper1\' native2unicode(hex2dec({'6c' '38'}), 'unicode')  native2unicode(hex2dec({'78' 'c1'}), 'unicode')  native2unicode(hex2dec({'4f' '53'}), 'unicode')  native2unicode(hex2dec({'78' 'c1'}), 'unicode')  native2unicode(hex2dec({'53' '16'}), 'unicode')  native2unicode(hex2dec({'6a' '21'}), 'unicode')  native2unicode(hex2dec({'57' '8b'}), 'unicode')  native2unicode(hex2dec({'66' 'f4'}), 'unicode')  native2unicode(hex2dec({'65' '39'}), 'unicode') ]);
...
model.param.set('cw', '0.2[mm]', [native2unicode(hex2dec({'67' '81'}), 'unicode')  native2unicode(hex2dec({'9f' '7f'}), 'unicode')  native2unicode(hex2dec({'5b' 'bd'}), 'unicode') ]);
...
model.component('comp1').material('mat3').selection.set([2 4 5]);
...
model.component('comp1').physics('mfnc').feature('mfc3').selection.set([2 4 5]);
...
model.component('comp1').view('view1').axis.set('xmin', 9.859353065490723);
model.component('comp1').view('view1').axis.set('xmax', 12.738981246948242);
model.component('comp1').view('view1').axis.set('ymin', 47.18794250488281);
model.component('comp1').view('view1').axis.set('ymax', 48.64915466308594);
...
model.result.export('plot1').set('filename', ['D:\GitHub\paper1\result2Cr13\' native2unicode(hex2dec({'6c' '38'}), 'unicode')  native2unicode(hex2dec({'78' 'c1'}), 'unicode')  native2unicode(hex2dec({'4f' '53'}), 'unicode')  native2unicode(hex2dec({'66' 'f4'}), 'unicode')  native2unicode(hex2dec({'65' '39'}), 'unicode') '\BHUp_R.txt']);
model.result.export('plot2').set('plot', 'lngr2');
model.result.export('plot2').set('filename', ['D:\GitHub\paper1\result2Cr13\' native2unicode(hex2dec({'6c' '38'}), 'unicode')  native2unicode(hex2dec({'78' 'c1'}), 'unicode')  native2unicode(hex2dec({'4f' '53'}), 'unicode')  native2unicode(hex2dec({'66' 'f4'}), 'unicode')  native2unicode(hex2dec({'65' '39'}), 'unicode') '\BHUp_L.txt']);
