...
% ModelBHUp3.m
%
% Model exported on Oct 20 2021, 21:02 by COMSOL 5.6.0.280.
...
model.component('comp1').view('view1').axis.set('xmin', 1.895079255104065);
model.component('comp1').view('view1').axis.set('xmax', 27.379087448120117);
model.component('comp1').view('view1').axis.set('ymin', 37.844093322753906);
model.component('comp1').view('view1').axis.set('ymax', 50.77547073364258);
...
model.result.export('plot1').set('filename', ['D:\GitHub\paper1\result2Cr13\' native2unicode(hex2dec({'6c' '38'}), 'unicode')  native2unicode(hex2dec({'78' 'c1'}), 'unicode')  native2unicode(hex2dec({'4f' '53'}), 'unicode')  native2unicode(hex2dec({'66' 'f4'}), 'unicode')  native2unicode(hex2dec({'65' '39'}), 'unicode') '\nochange3_R.txt']);
model.result.export('plot2').set('plot', 'lngr2');
model.result.export('plot2').set('filename', ['D:\GitHub\paper1\result2Cr13\' native2unicode(hex2dec({'6c' '38'}), 'unicode')  native2unicode(hex2dec({'78' 'c1'}), 'unicode')  native2unicode(hex2dec({'4f' '53'}), 'unicode')  native2unicode(hex2dec({'66' 'f4'}), 'unicode')  native2unicode(hex2dec({'65' '39'}), 'unicode') '\nochange3_L.txt']);
