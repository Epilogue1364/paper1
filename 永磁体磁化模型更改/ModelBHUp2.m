...
% ModelBHUp2.m
%
% Model exported on Oct 20 2021, 20:24 by COMSOL 5.6.0.280.
...
model.component('comp1').view('view1').axis.set('ymin', 38.9818000793457);
model.component('comp1').view('view1').axis.set('ymax', 49.63776397705078);
