...
% changeJx.m
%
% Model exported on Nov 29 2021, 20:54 by COMSOL 5.6.0.280.
...
model.label([native2unicode(hex2dec({'65' 'e0'}), 'unicode')  native2unicode(hex2dec({'67' '81'}), 'unicode')  native2unicode(hex2dec({'9f' '7f'}), 'unicode')  native2unicode(hex2dec({'60' 'c5'}), 'unicode')  native2unicode(hex2dec({'51' 'b5'}), 'unicode')  native2unicode(hex2dec({'4e' '0b'}), 'unicode')  native2unicode(hex2dec({'7f' '1d'}), 'unicode')  native2unicode(hex2dec({'96' '99'}), 'unicode')  native2unicode(hex2dec({'76' '84'}), 'unicode')  native2unicode(hex2dec({'78' 'c1'}), 'unicode')  native2unicode(hex2dec({'90' '1a'}), 'unicode')  native2unicode(hex2dec({'5b' 'c6'}), 'unicode')  native2unicode(hex2dec({'5e' 'a6'}), 'unicode') '.mph']);

model.param.set('jxh', '0.6[mm]', [native2unicode(hex2dec({'69' 'fd'}), 'unicode')  native2unicode(hex2dec({'9a' 'd8'}), 'unicode') ]);
model.param.set('jxw', '0.4[mm]', [native2unicode(hex2dec({'69' 'fd'}), 'unicode')  native2unicode(hex2dec({'5b' 'bd'}), 'unicode') ]);
model.param.set('cw', '0.28[mm]', [native2unicode(hex2dec({'67' '81'}), 'unicode')  native2unicode(hex2dec({'9f' '7f'}), 'unicode')  native2unicode(hex2dec({'5b' 'bd'}), 'unicode') ]);
model.param.set('jx', '0.2[mm]', [native2unicode(hex2dec({'95' 'f4'}), 'unicode')  native2unicode(hex2dec({'96' '99'}), 'unicode') ]);
...
model.component('comp1').geom('geom1').feature('r2').set('pos', {'10+jx' '43-wc'});
...
model.component('comp1').geom('geom1').feature('r3').set('pos', {'10+jx' '48+cw'});
...
model.component('comp1').geom('geom1').feature('ls1').set('coord1', [10 43]);
model.component('comp1').geom('geom1').feature('ls1').set('specify2', 'coord');
model.component('comp1').geom('geom1').feature('ls1').set('coord2', {'10+jx' '43'});
model.component('comp1').geom('geom1').create('ls2', 'LineSegment');
model.component('comp1').geom('geom1').feature('ls2').set('specify1', 'coord');
model.component('comp1').geom('geom1').feature('ls2').set('coord1', [10 48]);
model.component('comp1').geom('geom1').feature('ls2').set('specify2', 'coord');
model.component('comp1').geom('geom1').feature('ls2').set('coord2', {'10+jx' '48'});
...
model.component('comp1').geom('geom1').feature('ls3').set('coord2', {'10+jx' '43.5-(wc*cln-jxw+0.5)'});
...
model.component('comp1').geom('geom1').feature('ls4').set('coord2', {'10+jx' '48+wc*crn-jxw'});
...
model.component('comp1').mesh('mesh1').feature('fq1').selection.set([3 4 5]);
...
model.component('comp1').view('view1').axis.set('xmin', 6.501507759094238);
model.component('comp1').view('view1').axis.set('xmax', 20.268657684326172);
model.component('comp1').view('view1').axis.set('ymin', 35.42581558227539);
model.component('comp1').view('view1').axis.set('ymax', 42.324005126953125);
...
model.component('comp1').material('mat3').label('Pole');
...
model.component('comp1').material('mat4').label('Axle');
...
model.result.dataset('cln1').set('genpoints', {'10[mm]+0.4*jx' '48[mm]+wc*crn-jxw/2'; '10[mm]+0.4*jx' '48[mm]-jxw/2'});
model.result.dataset('cln2').set('genpoints', {'10[mm]+0.4*jx' '43[mm]+jxw/2'; '10[mm]+0.4*jx' '43[mm]-(wc*cln-jxw/2)'});
model.result.dataset('cln3').set('genpoints', {'10[mm]+0.4*jx' '43[mm]-(wc*cln-jxw/2)'; '10[mm]+0.4*jx' '48[mm]+wc*crn-jxw/2'});
...
model.result.export('plot1').set('filename', ['D:\GitHub\paper1\result2Cr13\' native2unicode(hex2dec({'6c' '38'}), 'unicode')  native2unicode(hex2dec({'78' 'c1'}), 'unicode')  native2unicode(hex2dec({'4f' '53'}), 'unicode')  native2unicode(hex2dec({'66' 'f4'}), 'unicode')  native2unicode(hex2dec({'65' '39'}), 'unicode') '\BHUpLine0.6-0.4-0.28_R.txt']);
model.result.export('plot2').set('plot', 'lngr2');
model.result.export('plot2').set('filename', ['D:\GitHub\paper1\result2Cr13\' native2unicode(hex2dec({'6c' '38'}), 'unicode')  native2unicode(hex2dec({'78' 'c1'}), 'unicode')  native2unicode(hex2dec({'4f' '53'}), 'unicode')  native2unicode(hex2dec({'66' 'f4'}), 'unicode')  native2unicode(hex2dec({'65' '39'}), 'unicode') '\BHUpLine0.6-0.4-0.28_L.txt']);
...
model.result.export('img1').set('width', '173');
model.result.export('img1').set('height', '108');
...
model.result.export('img1').set('title1d', true);
model.result.export('img1').set('fontsize', 9);
model.result.export('img1').set('size', 'manualprint');
model.result.export('img1').set('unit', 'px');
model.result.export('img1').set('height', '425*4');
...
model.result.export('img2').set('title1d', 'off');
...
model.result.export('img2').set('logo1d', true);
model.result.export('img2').set('title2d', true);
