...
% ModelWatch.m
%
% Model exported on Sep 11 2021, 15:20 by COMSOL 5.6.0.280.
...
model.component('comp1').view('view1').axis.set('xmin', 8.939925193786621);
model.component('comp1').view('view1').axis.set('xmax', 12.252105712890625);
model.component('comp1').view('view1').axis.set('ymin', 21.53104019165039);
model.component('comp1').view('view1').axis.set('ymax', 23.282470703125);
