...
% ModelWatch2.m
%
% Model exported on Sep 11 2021, 15:52 by COMSOL 5.6.0.280.
...
model.modelPath(['D:\' native2unicode(hex2dec({'5b' '66'}), 'unicode')  native2unicode(hex2dec({'4e' '60'}), 'unicode')  native2unicode(hex2dec({'8d' '44'}), 'unicode')  native2unicode(hex2dec({'65' '99'}), 'unicode') '\' native2unicode(hex2dec({'78' '14'}), 'unicode')  native2unicode(hex2dec({'7a' '76'}), 'unicode')  native2unicode(hex2dec({'75' '1f'}), 'unicode')  native2unicode(hex2dec({'96' '36'}), 'unicode')  native2unicode(hex2dec({'6b' 'b5'}), 'unicode') '\GitHub\paper1']);

model.label(['Model' native2unicode(hex2dec({'51' '68'}), 'unicode')  native2unicode(hex2dec({'66' 'f2'}), 'unicode')  native2unicode(hex2dec({'7e' 'bf'}), 'unicode') '.mph']);

model.param.set('jxh', '0.3[mm]', [native2unicode(hex2dec({'69' 'fd'}), 'unicode')  native2unicode(hex2dec({'9a' 'd8'}), 'unicode') ]);
model.param.set('jxw', '0.5[mm]', [native2unicode(hex2dec({'69' 'fd'}), 'unicode')  native2unicode(hex2dec({'5b' 'bd'}), 'unicode') ]);
model.param.set('cw', '0.12[mm]', [native2unicode(hex2dec({'67' '81'}), 'unicode')  native2unicode(hex2dec({'9f' '7f'}), 'unicode')  native2unicode(hex2dec({'5b' 'bd'}), 'unicode') ]);
...
model.param.set('cln', 'floor(20[mm]/wc)', [native2unicode(hex2dec({'5d' 'e6'}), 'unicode')  native2unicode(hex2dec({'69' 'fd'}), 'unicode')  native2unicode(hex2dec({'65' '70'}), 'unicode') ]);
model.param.set('crn', 'floor(20[mm]/wc)', [native2unicode(hex2dec({'53' 'f3'}), 'unicode')  native2unicode(hex2dec({'69' 'fd'}), 'unicode')  native2unicode(hex2dec({'65' '70'}), 'unicode') ]);
...
model.component('comp1').geom('geom1').feature('ls3').set('coord1', {'10' '42-cln*wc-jxw/2'});
model.component('comp1').geom('geom1').feature('ls3').set('specify2', 'coord');
model.component('comp1').geom('geom1').feature('ls3').set('coord2', {'10.1' '42-cln*wc-jxw/2'});
model.component('comp1').geom('geom1').create('ls4', 'LineSegment');
model.component('comp1').geom('geom1').feature('ls4').set('specify1', 'coord');
model.component('comp1').geom('geom1').feature('ls4').set('coord1', {'10' '49+wc*crn+jxw/2'});
model.component('comp1').geom('geom1').feature('ls4').set('specify2', 'coord');
model.component('comp1').geom('geom1').feature('ls4').set('coord2', {'10.1' '49+wc*crn+jxw/2'});
...
model.component('comp1').view('view1').axis.set('xmin', 9.340160369873047);
model.component('comp1').view('view1').axis.set('xmax', 11.647235870361328);
model.component('comp1').view('view1').axis.set('ymin', 21.193532943725586);
model.component('comp1').view('view1').axis.set('ymax', 23.006235122680664);
...
model.result.dataset('cln1').set('genpoints', {'10.06' '49[mm]+jxw/2+(crn)*wc'; '10.06' '49[mm]+jxw/2'});
model.result.dataset('cln2').set('genpoints', {'10.06' '42[mm]-jxw/2'; '10.06' '42[mm]-jxw/2-(cln)*wc'});
model.result.dataset('cln3').set('genpoints', {'10.06' '42[mm]-jxw/2'; '10.06' '49[mm]+jxw/2'});
...
model.result.export('plot1').set('filename', ['D:\' native2unicode(hex2dec({'5b' '66'}), 'unicode')  native2unicode(hex2dec({'4e' '60'}), 'unicode')  native2unicode(hex2dec({'8d' '44'}), 'unicode')  native2unicode(hex2dec({'65' '99'}), 'unicode') '\' native2unicode(hex2dec({'78' '14'}), 'unicode')  native2unicode(hex2dec({'7a' '76'}), 'unicode')  native2unicode(hex2dec({'75' '1f'}), 'unicode')  native2unicode(hex2dec({'96' '36'}), 'unicode')  native2unicode(hex2dec({'6b' 'b5'}), 'unicode') '\' native2unicode(hex2dec({'78' 'c1'}), 'unicode')  native2unicode(hex2dec({'6d' '41'}), 'unicode')  native2unicode(hex2dec({'4f' '53'}), 'unicode')  native2unicode(hex2dec({'5b' '9e'}), 'unicode')  native2unicode(hex2dec({'9a' '8c'}), 'unicode')  native2unicode(hex2dec({'5b' 'a4'}), 'unicode') '\1' native2unicode(hex2dec({'5c' '0f'}), 'unicode')  native2unicode(hex2dec({'8b' 'ba'}), 'unicode')  native2unicode(hex2dec({'65' '87'}), 'unicode') '1\0matlab' native2unicode(hex2dec({'80' '54'}), 'unicode')  native2unicode(hex2dec({'8c' '03'}), 'unicode') '\model2\result4\Line-jxh1[mm]-jxw0.9[mm]-cw0.24[mm]-normB_R.txt']);
model.result.export('plot2').set('plot', 'lngr2');
model.result.export('plot2').set('filename', ['D:\' native2unicode(hex2dec({'5b' '66'}), 'unicode')  native2unicode(hex2dec({'4e' '60'}), 'unicode')  native2unicode(hex2dec({'8d' '44'}), 'unicode')  native2unicode(hex2dec({'65' '99'}), 'unicode') '\' native2unicode(hex2dec({'78' '14'}), 'unicode')  native2unicode(hex2dec({'7a' '76'}), 'unicode')  native2unicode(hex2dec({'75' '1f'}), 'unicode')  native2unicode(hex2dec({'96' '36'}), 'unicode')  native2unicode(hex2dec({'6b' 'b5'}), 'unicode') '\' native2unicode(hex2dec({'78' 'c1'}), 'unicode')  native2unicode(hex2dec({'6d' '41'}), 'unicode')  native2unicode(hex2dec({'4f' '53'}), 'unicode')  native2unicode(hex2dec({'5b' '9e'}), 'unicode')  native2unicode(hex2dec({'9a' '8c'}), 'unicode')  native2unicode(hex2dec({'5b' 'a4'}), 'unicode') '\1' native2unicode(hex2dec({'5c' '0f'}), 'unicode')  native2unicode(hex2dec({'8b' 'ba'}), 'unicode')  native2unicode(hex2dec({'65' '87'}), 'unicode') '1\0matlab' native2unicode(hex2dec({'80' '54'}), 'unicode')  native2unicode(hex2dec({'8c' '03'}), 'unicode') '\model2\result4\data\Line-jxh1[mm]-jxw0.9[mm]-cw0.24[mm]-normB_L.txt']);
