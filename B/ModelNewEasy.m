...
model.result.export('plot1').set('filename', [data_path, 'Line-jxh',num2str(jxh),'-','jxw',num2str(jxw),'-','cw',num2str(cw),'-','cln',num2str(cln),'-','crn',num2str(crn),'-','normB_R.txt']);
model.result.export('plot2').set('plot', 'lngr2');
model.result.export('plot2').set('filename', [data_path, 'Line-jxh',num2str(jxh),'-','jxw',num2str(jxw),'-','cw',num2str(cw),'-','cln',num2str(cln),'-','crn',num2str(crn),'-','normB_L.txt']);
model.result.export('img1').set('sourceobject', 'pg1');
model.result.export('img1').set('pngfilename', [xian_path,'Xian-jxh',num2str(jxh),'-','jxw',num2str(jxw),'-','cw',num2str(cw),'-','cln',num2str(cln),'-','crn',num2str(crn),'-','normB.png']);
...
model.result.export('img2').set('pngfilename', [tu_path,'Picture-jxh',num2str(jxh),'-','jxw',num2str(jxw),'-','cw',num2str(cw),'-','cln',num2str(cln),'-','crn',num2str(crn),'-','normB.png']);
